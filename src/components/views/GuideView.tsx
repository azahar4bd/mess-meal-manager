    ...
    <div className="space-y-3">
      ...
      <section id="g-month" className="scroll-mt-3">
        <Card title="📅 মাস">
          <Bullets
            items={[
              <>নতুন মাস খুললে তার নিজস্ব খাতা তৈরি হয় — MonthID হয় <Code>(office)-YYYY-MM</Code>; মিল সবসময় ০ থেকে শুরু।</>,
              <><strong>সদস্য তালিকা স্বয়ংক্রিয়:</strong> নতুন মাস খোলামাত্র আগের মাসের সকল সক্রিয় সদস্য নিজে থেকেই চলে আসে — আলাদা করে কপি করার কোনো অপশন/ফরম্যাট নেই; সদস্য বাদ/যোগ প্রয়োজনে সদস্য তালিকা থেকে করা যায়।</>,
              ...
              <><strong>দেনা-পাওনার জমা (Paid Entry):</strong> রিপোর্ট পেজের <Code>সদস্য হিসাব</Code> টেবিলেই প্রতিটি সারিতে “দেনা-পাওনার জমা (৳)” ঘরে বসিয়ে ✓ চাপলেই জমা সংরক্ষণ হয়; পাশের “অবশিষ্ট দেনা-পাওনা” ঘরে বাকিটা দেখা যায় — ফুল দিলে অবশিষ্ট শূন্য, আংশিক দিলে বাকিটা জের থাকে।</>,
              <><strong>অবশিষ্ট দেনা-পাওনা স্বয়ংক্রিয় ক্যারি:</strong> নতুন মাস খোলার সময় প্রতিটি সদস্যের অবশিষ্ট বাকি নিজে থেকেই নতুন মাসে <strong>জের</strong> হিসেবে বসে যায়; পাওনা সমন্বয়-জমা হয় — কোনো টিক/অনুমতি লাগে না (বাকি মাফ হয় না)।</>,
              <><strong>“আগামী মাসে বাজার করে সমন্বয় করে দেবো”:</strong> জের থাকা সদস্য নতুন মাসে ফান্ড থেকে টাকা না নিয়ে বাজার করলে এন্ট্রিতে তাকে “নিজের টাকা থেকে কিনেছে” হিসাবে চিহ্নিত করুন — ওই টাকা আগে তার জের মেটাবে, বাড়তি থাকলে পাওনা হবে। জের থাকা অবস্থায় লাস্ট ব্যালেন্স জের বাদে দেখায়, আর সমন্বয়কারী প্রতিটি বাজারে (যেমন ১ম দিনে ৳১০০ বাজার) মূলধন ৳১০০ করে বাড়ে — বাজার-মোট ও মিল রেট আগের মতোই থাকে।</>,
              <><strong>জেরের নগদ পরিশোধ:</strong> জের থাকা সদস্য নগদ টাকা দিলে ফান্ড ট্যাবে ধরন <Code>জের পরিশোধ</Code> দিয়ে জমা করুন — জের কমবে, কিন্তু চলতি মাসের দেনা-পাওনায় সেটা ধরা হবে না।</>,
              <>মাস সবসময় খোলা থাকে — পুরনো মাসের যেকোনো হিসাব পরবর্তীতেও সংশোধন করা যায়; উপরের সুইচার থেকে যেকোনো মাস বেছে নিয়ে পুরনো হিসাব দেখা যায়।</>,
