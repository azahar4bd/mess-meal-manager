        ...
        <Card title="🧺 বাজার">
          <Bullets
            items={[
              ...
              <><strong>নিজের টাকা থেকে কিনেছে:</strong> কেউ ফান্ড থেকে টাকা না নিয়ে নিজের পকেট থেকে বাজার করলে “নিজের টাকা থেকে কিনেছে / Paid by” ঘরে তার নাম দিন — মাস শেষে ওই টাকা তার পাওনা হিসাবে যোগ হবে।</>,
        ...
        <Card title="📐 হিসাবের নিয়ম (অপরিবর্তনীয়)">
          <Bullets
            items={[
              ...
              <><strong>দেনা-পাওনা</strong> = (সদস্যের জমা/সমন্বয় + নিজের টাকা থেকে বাজার) − সর্বমোট খরচ → ধনাত্মক (+) = পাওনা, ঋণাত্মক (−) = দেনা</>,
        ...
        <Card title="📊 রিপোর্ট">
          <Bullets
            items={[
              ...
              <>সামারি টেবিলে থাকে: মিল • মিল রেট • মিল খরচ • অতিরিক্ত • <strong>মোট খরচ (−)</strong> • জমা/সমন্বয় (+) • নিজের টাকা থেকে বাজার (+) • দেনা-পাওনা (+/−) • স্থায়ী ফান্ড (আলাদা স্তম্ভ)।</>,
        ...
        <Card title="📅 মাস">
          <Bullets
            items={[
              ...
              <><strong>সদস্যের বাকি/পাওনা নতুন মাসে:</strong> “নতুন মাস” উইন্ডোতে <Code>আগের মাসের দেনা-পাওনা নতুন মাসে ক্যারি করুন</Code> টিক দিলে প্রতিটি সদস্যের বাকি (১ টাকা বা বেশি হলে) নতুন মাসে <strong>সমন্বয়/Adjustment জমা</strong> হিসাবে বসে যাবে — অর্থাৎ হিসাব শূন্য থেকে শুরু হবে কিন্তু বাকিটা ধরা থাকবে।</>,
              <>টিক না দিলে সবাই শূন্য থেকে শুরু করবে (বাকি মাফ নয় — পুরনো মাসের রিপোর্টে সেটা দেখা যাবে)।</>,
              <><strong>“আগামী মাসে বাজার করে পাওনা সমন্বয় করব”:</strong> ওই সদস্য নতুন মাসে ফান্ড থেকে টাকা না নিয়ে বাজার করলে এন্ট্রিতে তাকে “নিজের টাকা থেকে কিনেছে” হিসাবে চিহ্নিত করুন — মাস শেষে ওই টাকা তার পাওনা থেকে বাদ পড়ে সমন্বয় হয়ে যাবে।</>,
