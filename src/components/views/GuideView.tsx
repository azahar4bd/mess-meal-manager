        ...
        <Card title="🧺 বাজার">
          <Bullets
            items={[
              ...
              <><strong>আইটেম পপআপ:</strong> পরিমাণের ঘরের উপরের 🧾 আইকনে ক্লিক করুন → আইটেম, কোয়ান্টিটি, দাম লিখে <Code>এড</Code> চাপলে নিচের টেবিলে জমা হবে (এডিট/ডিলিট করা যায়, সেভ না করা পর্যন্ত থেকে যায়)।</>,
              <>পপআপে <Code>সেভ</Code> চাপলে মোট টাকা এন্ট্রির “পরিমাণ” ঘরে বসে যায় — চাইলে ওই ঘরে ম্যানুয়ালিও লিখতে বা বদলাতে পারবেন।</>,
