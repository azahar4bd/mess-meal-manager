        ...
        <Card title="📊 রিপোর্ট">
          <Bullets
            items={[
              ...
              <>সামারি টেবিলে থাকে: মিল • মিল রেট • মিল খরচ • অতিরিক্ত • <strong>মোট খরচ (−)</strong> • জমা/সমন্বয় (+) • নিজের টাকা থেকে বাজার (+) • দেনা-পাওনা (+/−) • স্থায়ী ফান্ড (আলাদা স্তম্ভ)। জের থাকলে বাড়তি তিন স্তম্ভ: প্রারম্ভিক জের • জের সমন্বয় • বাকি জের।</>,
        ...
        <Card title="📅 মাস">
          <Bullets
            items={[
              ...
              <><strong>নগদ ব্যালেন্স স্বয়ংক্রিয় ক্যারি:</strong> ক্লোজের সময় লাস্ট ব্যালেন্স নিজে থেকেই পরের মাসের প্রারম্ভিক নগদ হিসেবে বসে যায়; কিছু লিখতে হয় না। স্থায়ী ফান্ড আলাদা হিসাবেই থাকে।</>,
