        ...
        <Card title="📅 মাস">
          <Bullets
            items={[
              ...
              <><strong>দেনা-পাওনার জমা:</strong> রিপোর্ট পেজে <Code>সদস্য হিসেব</Code>-এর ঠিক নিচে <Code>💸 দেনা-পাওনা জমা</Code> টেবিলে প্রতি সদস্যের মোট দেনা, মোট জমা ও বাকি দেখা যায়; শেষের <Code>Edit</Code> থেকে জমা যোগ/সংশোধন আর <Code>Delete</Code> থেকে রেকর্ড মুছে ফেলা যায়। জমা দিলে দেনা কমে এবং লাস্ট ব্যালেন্স বাড়ে, বাজার-মোট ও মিল রেট ছোঁয় না।</>,
              ...
              <><strong>লাস্ট ব্যালেন্স:</strong> লাস্ট ব্যালেন্স = প্রকৃত হাত-নগদ − এখনো বাকি গত-মাসের জের। কোনো সদস্য নিজের টাকায় বাজার করে (বা নগদে) জের সমন্বয় করলে জের কমে এবং ফান্ড-বাজার বেঁচে যায় — ফলে লাস্ট ব্যালেন্স বাড়ে; বাজারটি এ মাসেরই খরচ হিসেবে গণ্য হয়, তাই বাজার-মোট, মিল রেট ও সবার মিল খরচ স্বাভাবিকভাবেই ঠিক থাকে। সদস্য সাধারণ/মাস-শেষ টাকা জমা দিলেও নগদ বাড়ে। মাস ক্লোজের সময় প্রকৃত হাত-নগদ (জের-বাদ-আগের সংখ্যা) পরের মাসে ক্যারি হয়, তাই চেইনে একই জের দুইবার গোনা হয় না।</>,
              <><strong>জেরের নগদ পরিশোধ:</strong> জের থাকা সদস্য নগদ টাকা দিলে ফান্ড ট্যাবে (বা জমা টেবিলের Edit-এ) ধরন <Code>জের পরিশোধ</Code> দিয়ে জমা করুন — জের ও বাকি দেনা কমবে, নগদ লাস্ট ব্যালেন্স বাড়বে।</>,
