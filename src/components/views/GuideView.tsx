        ...
        <Card title="📅 মাস">
          <Bullets
            items={[
              ...
              <><strong>মাস-শেষ পরিশোধ (Paid Entry):</strong> মাস বন্ধ করার আগে রিপোর্ট পেজের <Code>মাস-শেষ পরিশোধ</Code> কার্ডে প্রতিটি সদস্যের বাকি আদায় করুন — যার টাকা ফুল দিবে তার পরের মাসে কোনো জের থাকবে না, যে আংশিক দেবে তার বাকিটা জের হবে।</>,
              <><strong>বাকি (জের) নতুন মাসে:</strong> “নতুন মাস” উইন্ডোতে <Code>আগের মাসের বাকি (জের) নতুন মাসে ক্যারি করুন</Code> টিক থাকলে প্রতিটি সদস্যের বাকি (১ টাকা বা বেশি হলে) নতুন মাসে <strong>জের</strong> হিসাবে বসে যাবে; পাওনা আগের মতোই সমন্বয়-জমা হবে। টিক না দিলে সবাই শূন্য থেকে শুরু করবে (বাকি মাফ নয় — পুরনো মাসের রিপোর্টে সেটা দেখা যাবে)।</>,
              ...
              <>মাস বন্ধ করলে সেটি পড়া যায়, ম্যানেজাররা লিখতে পারেন না (তাদের লেখার চেষ্টা 403 দেয়) — তবে ভুলে বন্ধ হলে <strong>অ্যাডমিন/ম্যানেজার উপরের মাস বারের 🔓 মাস খুলুন</strong> বাটন (বা রিপোর্ট পেজ) থেকে যেকোনো সময় আবার খুলে সব হিসাব ঠিক করতে পারবেন; বন্ধ মাসে অ্যাডমিন চাইলে সরাসরি সংশোধনও করতে পারেন।</>,
              <>উপরের সুইচার থেকে যেকোনো মাস বেছে নিয়ে পুরনো হিসাব দেখা যায়।</>,
              <><strong>হেডার/ফুটার/Hero/নোটিশ পরিবর্তন:</strong> যেকোনো পেজে নিচে-ডানের ভাসমান <Code>✏️ এডিট</Code> বাটনে চাপুন — অ্যাপের নাম, হেডার টাইটেল/ট্যাগলাইন, ফুটার, লগইন পেজের Hero টাইটেল ও রঙের স্টাইল, ড্যাশবোর্ড শিরোনাম এবং উপরের স্ক্রলিং নোটিশ বার্তা এক জায়গা থেকেই বদলানো যায় (অ্যাডমিন গ্লোবাল/অফিস বেছে নিতে পারেন)।</>,
            ]}
          />
        </Card>
      </section>
