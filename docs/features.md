...
| E2E API | `npm run test:api` | **১৫৪টি চেক** — অথ, রোল, অফিস/মাস আইসোলেশন, CRUD, হিসাবের সূত্র, ক্লোজড মাস, এক্সপোর্ট, সিঙ্ক, সাইনআপ/জয়েন/অ্যাপ্রুভাল, অ্যাডমিন, লগআউট, ইনজেকশন |
